...
Lorsque j'étais à l'université, j'ai eu un professeur de sociologie
 ...
 Dans \bibleverse{ICo}(2:15), Paul dit\space:
...
Dans \bibleverse{Jn}(16:13), Jésus a promis à Ses disciples
 ...
 Paul a mis en garde les anciens de l'église d'Éphèse\space:
...
Pierre a mis en garde dans \bibleverse{IIPet}(2:1-3)\space:
...
Remarquez une des caractéristiques d'un faux prophète\space:
 ...
 Ces lettres disent des choses comme\space:
...
L'Esprit-Saint nous montre également des choses à venir.
 ...
 Alors que Daniel persistait à demander, à nouveau le Seigneur lui dit\space:
...
C'est par l'aide de l'Esprit-Saint qu'une compréhension claire
 ...
 dans \bibleverse{Acts}(20:22-23)\space:
 ...
 le prophète Agabus prit la ceinture de Paul, s'attacha avec, et dit\space:
 \og Voici ce que déclare le Saint-Esprit\space:
...
Un autre exemple dans la vie de Paul de ce travail de l'Esprit
 se trouve dans \bibleverse{Acts}(27:21-24)\space:
 \og On n'avait pas mangé depuis longtemps.
 Alors Paul, debout au milieu des hommes, leur dit\space:
 ...
 s'est approché de moi cette nuit et m'a dit\space:

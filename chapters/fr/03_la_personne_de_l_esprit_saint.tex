...
Dans \bibleverse{Rom}(8:27), Paul dit~: \og Et celui qui sonde les cœurs
 ...
 intercède en faveur des saints. \fg{} Ici, il est fait référence à la \emph{raison}
...
Remarquez le nombre de fois où Jésus utilise le pronom personnel pour
 ...
 ne viendra pas \emph{à} vous. Mais si je pars, je vous \emph{l}'enverrai.
 Et quand \emph{il} viendra,
 il prouvera aux gens de ce monde leur erreur au sujet du péché,
 ...
 supporter maintenant. Quand viendra l'Esprit de vérité, \emph{il} vous conduira
 dans toute la vérité. \emph{Il} ne parlera pas en \emph{son propre nom},
 mais il dira tout ce qu'\emph{il} aura entendu
 et vous annoncera ce qui doit arriver.
 \emph{Il} révélera ma gloire, car \emph{il} recevra
 de ce qui est à moi et vous l'annoncera. \fg{}
 Dans le texte grec, le pronom personnel \og il \fg{} est utilisé
 pour l'Esprit de très nombreuses fois dans les Écritures.
...
Pour Pierre, qui a renié son Seigneur en présence d'une seule servante,
 ...
 qu'ils reçoivent la \emph{puissance de l'Esprit-Saint}, car c'était par sa puissance

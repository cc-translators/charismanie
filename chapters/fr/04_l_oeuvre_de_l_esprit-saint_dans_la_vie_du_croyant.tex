...
\chlettrine[lraise=0.30,loversize=0.15]{Q}{uel} est le travail de l'Esprit attendu dans la vie du croyant ?
...
Mais lorsque vous croyez en Jésus-Christ,
 ...
 sont devenues nouvelles \fg{} (\bibleverse{IICor}(5:17)).
...
Dans \bibleverse{Eph}(4:13), nous voyons ce que Dieu veut faire en nous.
 Paul déclare~:
 ...
 Dans \bibleverse{Rom}(8:29), nous lisons
...
Dans \bibleverse{IICor}(3:6-18), Paul parle de la période
...
Nous sommes des pécheurs ; nous devons reconnaître ce fait ;
 ...
 C'est ce que faisait Paul dans \bibleverse{Rom}(7:) lorsqu'il a dit~:
...
Tant que je suis égoïste et centré sur moi-même,
 ...
 C'est ce dont Jésus parlait dans \bibleverse{Matt}(5:) lorsqu'il a dit~:
...
Oh, qu'il serait bon que nous nous soumettions à l'Esprit-Saint
 ...
 Dans \bibleverse{ICor}(13:), il y a un simple petit test d'auto-analyse

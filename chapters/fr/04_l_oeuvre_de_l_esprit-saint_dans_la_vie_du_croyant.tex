\chapter[L'œuvre de l'Esprit-Saint dans la vie du croyant]{L'œuvre de l'Esprit-Saint\\ dans la vie du croyant}
...
Alors que nous vivons selon l'Esprit, nos formes de pensée sont différentes
 ...
 Les tendances de l'Esprit, c'est la vie et la paix (\bibleverse{Rm}(8:6)).
...
Dans \bibleverse{Jn}(16:13), Jésus a promis à Ses disciples
 ...
 et pourtant paraîtraient habillés comme des agneaux (\bibleverse{Mt}(7:15)).
...
Pierre a mis en garde dans \bibleverse{IIP}(2:1,3)~:
...
C'est avec l'aide de l'Esprit-Saint qu'une compréhension claire
 ...
 entre les mains des païens \fg{} (\bibleverse{Ac}(21:11)).
...
Un autre exemple dans la vie de Paul de ce travail de l'Esprit
 se trouve dans \bibleverse{Ac}(27:21-24)~:
...
L'œuvre de l'Esprit-Saint dans votre vie si vous êtes un croyant
 ...
 La Bible parle de cette frustration dans \bibleverse{Rm}(7:),
 ...
 Paul décrit dans \bibleverse{Ga}(5:) comment la chair lutte avec l'esprit
...
Quelques semaines plus tard, Pierre s'est retrouvé face au même groupe
 ...
 sauvés \fg{} (\bibleverse{Ac}(4:5-12)).

Lorsqu'ils virent l'assurance de Pierre, ils furent étonnés
 (\bibleverse{Ac}(4:13)). Il s'agissait d'une personne différente
...
Puis, il a répondu a sa propre question~:
 ...
 Alors que nous arrivons dans \bibleverse{Rm}(8:),
...
Quelle histoire différente de celle de la défaite et du triste désespoir
 ...
 notre Seigneur. \fg{} (\bibleverse{Rm}(8:37-39)).
...
Dans le sermon sur la montagne, Jésus a fait une affirmation remarquable,
 ...
 Dans \bibleverse{Mt}(5:20), Il a dit~:
...
Il pourrait donc sembler que Jésus fermait la porte du Royaume de Dieu.
 Finalement, nous arrivons au dernier verset de \bibleverse{Mt}(5:),
...
Mais lorsque vous croyez en Jésus-Christ,
 ...
 sont devenues nouvelles \fg{} (\bibleverse{IICo}(5:17)).
...
Dans \bibleverse{Ep}(4:13), nous voyons ce que Dieu veut faire en nous.
 Paul déclare~:
 ...
 Dans \bibleverse{Rm}(8:29), nous lisons
...
Dans \bibleverse{IICo}(3:6-18), Paul parle de la période
...
Nous sommes des pécheurs ; nous devons reconnaître ce fait ;
 ...
 C'est ce que faisait Paul dans \bibleverse{Rm}(7:) lorsqu'il a dit~:
...
Tant que je suis égoïste et centré sur moi-même,
 ...
 C'est ce dont Jésus parlait dans \bibleverse{Mt}(5:) lorsqu'il a dit~:
...
Personne ne me connait aussi bien que moi-même, sinon le Seigneur,
...
Je sais que je suis désormais un fils de Dieu,
 ...
 à ceux qui croient en son nom \fg{} (\bibleverse{Jn}(1:12)).
...
Oh, qu'il serait bon que nous nous soumettions à l'Esprit-Saint
 ...
 Dans \bibleverse{ICo}(13:), il y a un simple petit test d'auto-analyse

...
\emph{La joie} est la conscience de l'amour.
...
Une autre caractéristique de l'agapé est la \emph{fidélité}
 ...
 \NdT{La Bible King James Version traduit le mot greg \emph{pistis} par
 \emph{faith} (foi) alors que la Colombe utilise le mot \og fidélité \fg{}.
 La Bible Parole de Vie quant à elle parle de \og confiance
 dans les autres \fg{}.}.
...
Enfin, il y a la \emph{douceur} (ou \emph{soumission})
 ...
 \emph{praotes} par  \og douceur \fg{} alors que la Bible King James Version

...
Nous lisons dans \ibibleverse{Ga}(5:) au sujet de la bataille spirituelle
...
Une autre caractéristique de l'agapé est la fidélité (ou la foi).
 ...
 \NdT{La Bible King James Version utilise le mot \emph{faith} (foi)
 alors que la Colombe utilise le mot \og fidélité \fg{}.
 La Bible Parole de Vie parle de \og confiance dans les autres \fg{}.}.
...
Enfin, il y a la douceur (ou soumission)
 \NdT{La plupart des Bibles francophones utilisent le mot
 \og douceur \fg{} alors que la King James Version utilise
 le mot \emph{meekness}, qui signifie \og soumission \fg{}.}.

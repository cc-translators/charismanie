...
\lettrineP{uisque le but} de ce livre est de vous amener
...
Parce que c'est un des domaines ou l'ennemi attaque constamment, nous devons
 affirmer non seulement la divinité de l'Esprit-Saint com\-me un fait,
...
Dans \ibibleverse{Gn}(1:1), nous lisons~:
...
En continuant dans \ibibleverse{Gn}(1:2), nous lisons~:
 ...
 Dans \ibibleverse{Gn}(1:26), nous lisons~:
...
Un autre attribut de Dieu est son omniscience. Dieu sait toute chose, comme
 Jacques le dit dans \ibibleverse{Ac}(15:18)~:
 \og [\dots{}], dit le Seigneur, qui fait ces choses connues de toute éternité. \fg{}
 \NdT{La citation anglaise est issue de la traduction \emph{King James}
 qui diffère notoirement des autres traductions sur ce verset.
 La version \emph{King James Française} traduit \ibibleverse{Ac}(15:18) par~:
 \og Toutes ses œuvres sont connues à Dieu depuis le commencement du monde. \fg{}}.
 Cet attribut est également assigné à
 l'Esprit-Saint. Dans \ibibleverse{ICo}(2:10-11), nous lisons~: \og À nous, Dieu
...
Un autre attribut du divin est l'omniprésence. Dieu existe partout dans
 l'univers en même temps. Dans le \ibibleverse{Ps}(139:7), David deman\-de~:
 ...
 (\ibibleverse{Gn}(18:14)). Jésus a dit~: \og Tout est possible à Dieu \fg{}
 (\ibibleverse{Mc}(10:27)). Dans \ibibleverse{Lc}(1:37), Il a dit~:
...
Non seulement les \emph{attributs} divins s'appliquent à l'Esprit-Saint, mais
 ...
 Dans \ibibleverse{Jn}(1:1-3), nous lisons~:
 ...
 Dieu a dit~: \og Faisons l'homme à \emph{notre} image \fg{} (\ibibleverse{Gn}(1:26)).
 Dans le \ibibleverse{Ps}(104:30), nous lisons~:
 ...
 \ibibleverse{Gn}(1:1) et par \og souffle \fg{} dans le \ibibleverse{Ps}(104:30).}.
...
La Bible a été écrite sous l'inspiration de l'Esprit-Saint, pourtant nous
 ...
 Dans \ibibleverse{IITm}(3:16), Paul déclare~:
...
C'est pourquoi beaucoup d'Écritures dans l'Ancien Testament qui déclarent que
 \emph{le Seigneur} a parlé sont attribués à l'Esprit-Saint lors\-
 qu'elles sont citées dans le Nouveau Testament.
 Dans \ibibleverse{Is}(6:8-9), le prophète a dit~: \og J'entendis la voix du
 ...
 apprenez rien ! \fg{}
 Lorsque Paul a cité ce passage dans \ibibleverse{Ac}(28:25-26), il a dit~:
...
Dans \ibibleverse{IICo}(13:14), dans sa bénédiction apostolique, Paul a dit~:
...
Dans \ibibleverse{ICo}(12:4-6), Paul dit~:
 ...
 Au verset \ibiblevs{ICo}(12:4), il se réfère à l'Esprit,
 au verset \ibiblevs{ICo}(12:5) au Seigneur (Jésus)
 et au verset \ibiblevs{ICo}(12:6) à Dieu (le Père).
...
À ce point, il est possible que vous vous demandiez~:
...
Jésus a dit~: \og Nul ne vient au Père si ce n'est par moi \fg{}
 ...
 Dans \ibibleverse{Is}(59:1-2), nous lisons~:

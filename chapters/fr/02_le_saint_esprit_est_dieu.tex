...
Dans \bibleverse{Gn}(1:1), nous lisons~:
...
En continuant dans \bibleverse{Gn}(1:2), nous lisons~:
 ...
 Dans \bibleverse{Gn}(1:26), nous lisons~:
...
Pour établir que l'Esprit-Saint est Dieu, nous allons tout d'abord montrer
 ...
 Il a toujours existé. Dans \bibleverse{He}(9:14), nous lisons que Christ,
...
Un autre attribut de Dieu est son omniscience. Dieu sait toute chose, comme
 Jacques le dit dans \bibleverse{Ac}(15:18)~:
 ...
 La version \emph{King James Française} traduit \bibleverse{Ac}(15:18) par~:
...
Un autre attribut du divin est l'omniprésence. Dieu existe partout dans
 ...
 (\bibleverse{Gn}(18:14)). Jésus a dit~: \og Tout est possible à Dieu \fg{}
...
Non seulement les \emph{attributs} divins s'appliquent à l'Esprit-Saint, mais
 ...
 Dans \bibleverse{Gn}(1:2), l'Esprit est décrit comme planant au-dessus
 des eaux. L'Esprit était en communication avec le Père et le Fils quand
 Dieu a dit~: \og Faisons l'homme à \emph{notre} image \fg{} (\bibleverse{Gn}(1:26)).
 Dans le \bibleverse{Ps}(104:30), nous lisons~:
 ...
 \bibleverse{Gn}(1:1) et par \og souffle \fg{} dans le \bibleverse{Ps}(104:30).}.
...
La Bible a été écrite sous l'inspiration de l'Esprit-Saint, pourtant nous
 ...
 Dans \bibleverse{IITm}(3:16), Paul déclare~:
...
C'est pourquoi beaucoup d'Écritures dans l'Ancien Testament qui déclarent que
 ...
 apprenez rien ! \fg{}
 Lorsque Paul a cité ce passage dans \bibleverse{Ac}(28:25-26), il a dit~:
...
Dans \bibleverse{Ac}(5:1-11), nous avons un témoignage intéressant de
...
À ce point, il est possible que vous vous demandiez~:
 ...
 que nous sommes enfants de Dieu \fg{} (\bibleverse{Rm}(8:16)).

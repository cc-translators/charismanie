...
\lettrine{L}{e but} de ce livre étant de vous faire entrer
 ...
 est l'une des trois personnes de la Divinité\NdT{Le terme anglais \emph{Godhead},
 littéralement \Og Tête Divine \Fg{}, désigne le Dieu unique en trois personnes;
...
Le voile dans le tabernacle démontrait la séparation qui doit exister entre
 ...
 et des sacrifices effectués par le grand-prêtre\NdT{L'expression \emph{grand-prêtre},
 qui se trouve dans les textes originaux, est traduite par l'expression \Og souverain sacrificateur \Fg{}
 dans la Bible Segond Révisée. Louis Segond, le théologien suisse du \textsc{xix}\ieme ~siècle qui
 l'a formulée, s'interdisait l'usage du mot \Og prêtre \Fg{} pour se démarquer radicalement de la foi catholique.},

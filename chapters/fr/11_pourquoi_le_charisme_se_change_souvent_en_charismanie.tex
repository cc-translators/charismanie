...
Un autre passe-temps populaire au sein de nombreux groupes charismatiques
...
Paul, écrivant aux Corinthiens, a dit que nos corps sont les temples
 ...
 (\ibibleverse{IICo}(6:14-16)). En \ibibleverse{ICo}(10:20),
...
Une grande partie de l'expérience d'adoration de l'homme relève plus
 ...
 En \ibibleverse{He}(4:12), nous lisons que la Parole de Dieu
...
En \ibibleverse{Mt}(6:), Jésus nous prévient que nous devons faire attention
...
Les méthodes par lesquelles les offrandes sont reçues
...
En \ibibleverse{IIP}(2:3), il est dit que l'un des signes
...
\section{Suffit-il de revendiquer pour recevoir ?}
...
Le dernier vent de doctrine pernicieuse et non scripturaire à \linebreak
 ...
 De tels enseignements ressemblent plus à ceux de Mary Baker Eddy\NdT{Fondatrice de la secte de la \Og Science Chrétienne \Fg{}.}
...
Ces gens parlent beaucoup de faire des confessions positives,
 ...
 de \emph{Science et Santé avec la Clef des Écritures}\NdT{Livre d'étude de la secte de la \Og Science Chrétienne \Fg{}.} plutôt que de la Bible.

...
Jésus a dit en \ibibleverse{Ap}(3:20)\frcolon{}
...
Le chrétien est en fait la personne la plus bénie au monde.
 ...
 En \ibibleverse{Ep}(1:13), Paul dit\frcolon{}
...
La vérité biblique dans toute sa beauté, c'est que, une fois que j'ai cru,
...
Je ne comprend pas pourquoi Dieu m'attribue une si grande valeur,
 mais c'est le cas.
 En \ibibleverse{Ep}(1:18), Paul dit\frcolon{}
 ...
 On peut le lire également en \ibibleverse{IICo}(1:22)\frcolon{}
 \Og Il nous a aussi marqués de son sceau et a mis dans nos cœurs
 les arrhes de l'Esprit. \Fg{}
 En \ibibleverse{Ep}(4:30), nous recevons le commandement suivant\frcolon{}
...
En \ibibleverse{Ep}(1:14), Paul déclare\frcolon{}
...
Cette rédemption ne sera complète que lorsque nous serons libérés
 ...
 En \ibibleverse{Rm}(8:22), il décrit comment nous
...
Le nouveau corps que je vais avoir ne sera pas hérité de l'homme déchu ;
 ...
 En \ibibleverse{IICo}(5:4), Paul appelle ce corps présent une \Og tente \Fg{}.
...
Jésus a acquis le monde, mais Il ne l'a pas encore revendiqué.
 ...
 Le chapitre~\ibiblechvs{Ap}(5:) de l'Apocalypse nous en parle.
...
Une autre œuvre de l'Esprit-Saint dans la vie du croyant,
 ...
 Je suis coincé avec ce seul mot \Og aimer \Fg{}\NdT{Malgré l'argumentation de l'auteur concernant la richesse relative
...
L'amour agapé continue d'aimer même si il n'y a pas d'amour en retour.
 ...
 est~probablement en \ibibleverse{ICo}(13:).
...
En \ibibleverse{IJn}(3:14), on peut lire\frcolon{}

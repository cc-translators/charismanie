...
Je ne comprend pas pourquoi Dieu me considère d'une si grande valeur,
 mais c'est le cas.
 Dans \bibleverse{Eph}(1:18), Paul dit~:
 ...
 On nous le dit également dans \bibleverse{IICor}(1:22)~:
 \og Il nous a aussi marqués de son sceau et a mis dans nos cœurs
 les arrhes de l'Esprit. \fg{}
 Dans \bibleverse{Eph}(4:30), nous recevons le commandement suivant~:
...
Dans \bibleverse{Eph}(1:14), Paul déclare~:
...
Cette rédemption ne sera complète que lorsque nous serons libérés
 ...
 Dans \bibleverse{Rom}(8:22), il décrit comment nous
...
Robert Service, dans son poème \emph{La crémation de Sam Magee},
 ...
 trouvés vêtus et non pas nus \fg{} (voir \bibleverse{IICor}(5:1-4)).

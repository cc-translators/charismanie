...
\lettrine[lines=3]{P}{uisque} le but de ce livre est de vous amener
...
Dans \bibleverse{Gen}(1:1), nous lisons~:
...
En continuant dans \bibleverse{Gen}(1:2), nous lisons~:
 ...
 Dans \bibleverse{Gen}(1:26), nous lisons~:
 \og Puis Dieu dit~: Faisons l'homme à notre image selon notre ressemblance. \fg{}
 Il n'a pas dit~: \og Je vais faire l'homme à mon image. \fg{}
...
Non seulement les attributs divins s'appliquent à l'Esprit-Saint, mais
 ...
 Dans \bibleverse{Jn}(1:1-3), nous lisons~:
 ...
 Dieu a dit~: \og Faisons l'homme à notre image \fg{} (\bibleverse{Gen}(1:26)).
 Dans \bibleverse{Ps}(104:30), nous lisons~:
...
La Bible a été écrite sous l'inspiration de l'Esprit-Saint, pourtant nous
 ...
 \bibleverse{IIPet}(1:21) nous dit~:
 ...
 Dans \bibleverse{IITim}(3:16), Paul déclare~:
...
C'est pourquoi beaucoup d'Écritures dans l'Ancien Testament qui déclarent que
 ...
 Dans \bibleverse{Is}(6:8-9), le prophète a dit~: \og J'entendis la voix du
 ...
 apprenez rien ! \fg{}
 Lorsque Paul a cité ce passage dans \bibleverse{Acts}(28:25-26), il a dit~:
